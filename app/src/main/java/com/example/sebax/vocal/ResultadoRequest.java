...
public class ResultadoRequest extends StringRequest {
    ...
    private static final String RESULTADO_REQUEST_URL="http://192.168.0.100/verificar.php";
    private Map<String,String> params;
    public ResultadoRequest(String Nombre, String Rut, Response.Listener<String> listener){
